...
public:
    ...
    hashvaluetype hashString(std::string &str) {
        hashvalue = 0;
    ...
    hashvaluetype update(hashvaluetype myhashvalue, chartype outchar, chartype inchar) {
        hashvaluetype z (hasher.hashvalues[outchar]);
        fastleftshiftn(z);
        myhashvalue =  getfastleftshift1(myhashvalue)
                     ^ z
                     ^ hasher.hashvalues[inchar];
		return myhashvalue;
    }
	...
	hashvaluetype reverse_update(hashvaluetype myhashvalue, chartype outchar, chartype inchar) {
        hashvaluetype z (hasher.hashvalues[outchar]);
        fastleftshiftn(z);
        myhashvalue ^=   z ^ hasher.hashvalues[inchar];
        myhashvalue = getfastrightshift1(myhashvalue);
		return myhashvalue;
    }
    ...
    hashvaluetype eat(hashvaluetype myhashvalue, chartype inchar) {
        fastleftshift1(myhashvalue);
        myhashvalue ^= hasher.hashvalues[inchar];
    }
